...
var mkap = (function () {
    ...
    MomentKappa.prototype.solver = function (strain_top, strain) {
        /**
         * Return the .det_stress method several times and adapt the values until the convergence criteria is met.
         *
        ...
        var a = this.compressive_diagram.det_stress(-top_str) * this.cross_section.area() * 0.1;
